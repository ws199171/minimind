...
from model.model_lora import save_lora, apply_lora  # LoRA专用函数
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="MiniMind LoRA 微调")
    ...
    parser.add_argument("--epochs", type=int, default=50, help="训练轮数（LoRA通常需要更多epoch）")
    parser.add_argument("--batch_size", type=int, default=32, help="batch size")
    parser.add_argument("--learning_rate", type=float, default=1e-4, help="初始学习率（LoRA可使用较大学习率）")
    ...
    parser.add_argument('--from_weight', default='full_sft', type=str, help="基于哪个权重训练（通常为full_sft）")
